...
function About() {
  ...
  <div className="max-w-7xl mx-auto rounded-2xl px-6 py-2">
    <div className="flex flex-col md:flex-row items-center rounded-xl">
      ...
      <div className="w-full p-4">
        <h2 className="text-4xl sm:text-9xl font-bold mb-2 text-zinc-700">Sobre mi</h2>
  ...
  <h2 className="text-4xl sm:text-9xl text-center font-bold mb-2 text-zinc-700 py-16">Servicios</h2>
<div>
  <div className="container px-4 md:px-12 py-12 mx-auto">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 border rounded-lg shadow bg-emerald-200  border-black border-b-[4px] p-4 md:p-6 text-center">
      <div className="flex flex-wrap flex-col items-center justify-center px-1 md:px-6">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
          className="w-8 h-8 dark:text-indigo-500">
