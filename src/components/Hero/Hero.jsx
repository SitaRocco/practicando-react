   ...
   lg:mt-48">
    <div className="mt-36 mb-20 p-6  text-center flex flex-col justify-center items-center bg-zinc-100 rounded-xl border border-black border-b-[4px]">
      ...
      <div className=" flex flex-col sm:flex-row justify-center gap-4 mt-6">
        <a href="#proyectos">
          <button className="  w-full cursor-pointer rounded-3xl  py-3 bg-gradient-to-r from-indigo-200 to-indigo-400 text-zinc-700 font-bold text-xl px-20 hover:from-indigo-300 hover:to-indigo-500 hover:text-white hover:scale-105 transition-all duration-300">
            Ver Proyectos
          </button>
        </a>
      </div>
