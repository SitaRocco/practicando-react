...
<section className="overflow-hidden ">
  ...
  <div className=" px-6 lg:px-44  py-24" >
    ...
    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 ">
            <img src={mockup4} alt="mockup-patadepato-web" class="w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] md:-ml-4 lg:-ml-0" className="w-250 sm:w-900 rounded-xl shadow-xl ring-1 ring-gray-400/10"/>
        ...
        <div className=" lg:max-w-6xl">
          ...
          <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
            <div className="relative pl-9">
              ...
              <dd className="inline">Sección "Productos Destacados":

Se diseñó una sección donde, junto a los accesorios, se integró una imagen que muestra parte del proceso artesanal de confección de los productos, destacando el trabajo manual y el enfoque sostenible de la marca. También se incorporaron los enlaces a las redes sociales del cliente para facilitar el contacto directo.
              </dd>
            </div>
            <div className="relative pl-9">
              ...
              <dd className="inline">Sección "Visito tu colegio":

             Se incluyó un video que muestra las charlas medioambientales que el cliente realiza en colegios, acompañado de un formulario de contacto para facilitar la gestión de visitas educativas.</dd>
            </div>
            <div className="relative pl-9">
              <dt className="inline font-semibold text-gray-900"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                  fill="currentColor" aria-hidden="true" className="absolute left-1 top-1 h-5 w-5 text-indigo-400">
              ...
              <dd class="inline">Sección "Nuestra Historia":

              Se desarrolló una sección narrativa donde se presentan los inicios de la marca y el trabajo de la cuadrilla de limpieza de playas, resaltando el compromiso medioambiental y comunitario.
              </dd>
            </div>
          </dl>
        </div>
